...
Finally, we're going to visualise the clustering using t-SNE projection. The plots above help us understand the data but are hard to infer anything from. We'll visualise the DBSCAN200 data below.
